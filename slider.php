<?php
  ...
  for ($i=0; $i < 3; $i++) {
    ...
    $rows[$i] = $row;
    $rows[$i][3] = (strlen(strval($rows[$i][3])) >= 203) ? substr(strval($rows[$i][3]),0,199) . '...' : strval($rows[$i][3]);
  }
  $coming  = $rows[0];
  $current = $rows[1];
  $past    = $rows[2];
  ...
  <div class="slider">
    <div class="slider__wrapper">
      ...
      <a class="slider__control slider__control_prev" href="#" role="button" style="display: grid;"></a>
      <a class="slider__control slider__control_next" href="#" role="button" style="display: grid;"></a>
    </div>
